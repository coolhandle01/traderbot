...
class Trader:
    ...
    def __init__(self, stock: Stock, broker: Broker, strat: Strategy) -> None:
        ...
        self.capital = self.broker.capital(self.symbol)

    def evaluate(self) -> Signal:
        """analyse the history with the given strategy"""
        self.analysis.append(self.stock.tail())
    ...
    def buy(self):
        ...
        self.position = self.broker.buy(self.symbol, self.capital)
        self.capital = 0
    ...
    def sell(self):
        ...
        self.capital = self.broker.sell(self.symbol, self.position)
        self.position = 0
    ...
    def trade(self):
        ...
        match self.evaluate():
            ...
            case _:
                pass
        print(f'changed position on {self.stock.symbol}: ${self.capital}: {self.position}')
